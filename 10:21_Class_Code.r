...
mean(iris$Sepal.Width[iris$Species == "setosa"], na.rm = TRUE)
mean(iris$Petal.Length[iris$Species == "setosa"], na.rm = TRUE)
mean(iris$Petal.Width[iris$Species == "setosa"], na.rm = TRUE)
